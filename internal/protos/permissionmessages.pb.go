...
var file_permissionmessages_proto_goTypes = []any{
...
func file_permissionmessages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_permissionmessages_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_permissionmessages_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_permissionmessages_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_permissionmessages_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_permissionmessages_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_permissionmessages_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_permissionmessages_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_permissionmessages_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_permissionmessages_proto_msgTypes[8].Exporter = func(v any, i int) any {
	...
	file_permissionmessages_proto_msgTypes[0].OneofWrappers = []any{
		(*Permissions_SuperUser)(nil),
		(*Permissions_Explicit)(nil),
	}
	file_permissionmessages_proto_msgTypes[2].OneofWrappers = []any{
		(*PermissionsType_CachePermissions_)(nil),
		(*PermissionsType_TopicPermissions_)(nil),
	}
	file_permissionmessages_proto_msgTypes[4].OneofWrappers = []any{
		(*PermissionsType_CacheSelector_CacheName)(nil),
	}
	file_permissionmessages_proto_msgTypes[5].OneofWrappers = []any{
		(*PermissionsType_CacheItemSelector_Key)(nil),
		(*PermissionsType_CacheItemSelector_KeyPrefix)(nil),
	}
	file_permissionmessages_proto_msgTypes[6].OneofWrappers = []any{
	...
	file_permissionmessages_proto_msgTypes[7].OneofWrappers = []any{
		(*PermissionsType_TopicSelector_TopicName)(nil),
		(*PermissionsType_TopicSelector_TopicNamePrefix)(nil),
	}
	file_permissionmessages_proto_msgTypes[8].OneofWrappers = []any{
