...
func (c *pingClient) Ping(ctx context.Context, in *XPingRequest, opts ...grpc.CallOption) (*XPingResponse, error) {
	out := new(XPingResponse)
	err := c.cc.Invoke(ctx, "/cache_client.Ping/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingServer) Ping(context.Context, *XPingRequest) (*XPingResponse, error) {
...
func _Ping_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cache_client.Ping/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServer).Ping(ctx, req.(*XPingRequest))
	}
...
var Ping_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/cacheping.proto",
}
