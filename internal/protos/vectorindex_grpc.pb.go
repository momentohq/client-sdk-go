...
// UnimplementedVectorIndexServer must be embedded to have
...
func (UnimplementedVectorIndexServer) testEmbeddedByValue()                     {}
...
func RegisterVectorIndexServer(s grpc.ServiceRegistrar, srv VectorIndexServer) {
	// If the following call pancis, it indicates UnimplementedVectorIndexServer was
