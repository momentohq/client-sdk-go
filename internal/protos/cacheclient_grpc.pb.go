...
func (c *scsClient) GetBatch(ctx context.Context, in *XGetBatchRequest, opts ...grpc.CallOption) (Scs_GetBatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Scs_ServiceDesc.Streams[0], Scs_GetBatch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &scsGetBatchClient{stream}
...
type scsGetBatchClient struct {
	grpc.ClientStream
}

func (x *scsGetBatchClient) Recv() (*XGetResponse, error) {
	m := new(XGetResponse)
...
func (c *scsClient) SetBatch(ctx context.Context, in *XSetBatchRequest, opts ...grpc.CallOption) (Scs_SetBatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Scs_ServiceDesc.Streams[1], Scs_SetBatch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &scsSetBatchClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type scsSetBatchClient struct {
	grpc.ClientStream
}

func (x *scsSetBatchClient) Recv() (*XSetResponse, error) {
	m := new(XSetResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *scsClient) SetIf(ctx context.Context, in *XSetIfRequest, opts ...grpc.CallOption) (*XSetIfResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_SetIf_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scsClient) ItemGetTtl(ctx context.Context, in *XItemGetTtlRequest, opts ...grpc.CallOption) (*XItemGetTtlResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_ItemGetTtl_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scsClient) ItemGetType(ctx context.Context, in *XItemGetTypeRequest, opts ...grpc.CallOption) (*XItemGetTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_ItemGetType_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scsClient) DictionaryLength(ctx context.Context, in *XDictionaryLengthRequest, opts ...grpc.CallOption) (*XDictionaryLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_DictionaryLength_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scsClient) SetSample(ctx context.Context, in *XSetSampleRequest, opts ...grpc.CallOption) (*XSetSampleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_SetSample_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scsClient) SetLength(ctx context.Context, in *XSetLengthRequest, opts ...grpc.CallOption) (*XSetLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_SetLength_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scsClient) SetPop(ctx context.Context, in *XSetPopRequest, opts ...grpc.CallOption) (*XSetPopResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_SetPop_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scsClient) SortedSetLength(ctx context.Context, in *XSortedSetLengthRequest, opts ...grpc.CallOption) (*XSortedSetLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_SortedSetLength_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *scsClient) SortedSetLengthByScore(ctx context.Context, in *XSortedSetLengthByScoreRequest, opts ...grpc.CallOption) (*XSortedSetLengthByScoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scs_SortedSetLengthByScore_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedScsServer) SetBatch(*XSetBatchRequest, Scs_SetBatchServer) error {
...
func _Scs_GetBatch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ScsServer).GetBatch(m, &scsGetBatchServer{stream})
}
...
type scsGetBatchServer struct {
	grpc.ServerStream
}

func (x *scsGetBatchServer) Send(m *XGetResponse) error {
...
func _Scs_SetBatch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ScsServer).SetBatch(m, &scsSetBatchServer{stream})
}
...
type scsSetBatchServer struct {
	grpc.ServerStream
}

func (x *scsSetBatchServer) Send(m *XSetResponse) error {
	return x.ServerStream.SendMsg(m)
}
