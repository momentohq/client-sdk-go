...
type AuthClient interface {
	Login(ctx context.Context, in *XLoginRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[XLoginResponse], error)
...
func (c *authClient) Login(ctx context.Context, in *XLoginRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[XLoginResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Auth_ServiceDesc.Streams[0], Auth_Login_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[XLoginRequest, XLoginResponse]{ClientStream: stream}
...
type Auth_LoginClient = grpc.ServerStreamingClient[XLoginResponse]
...
func (c *authClient) GenerateApiToken(ctx context.Context, in *XGenerateApiTokenRequest, opts ...grpc.CallOption) (*XGenerateApiTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_GenerateApiToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) RefreshApiToken(ctx context.Context, in *XRefreshApiTokenRequest, opts ...grpc.CallOption) (*XRefreshApiTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_RefreshApiToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	Login(*XLoginRequest, grpc.ServerStreamingServer[XLoginResponse]) error
	// api for initially generating api and refresh tokens
...
func (UnimplementedAuthServer) Login(*XLoginRequest, grpc.ServerStreamingServer[XLoginResponse]) error {
...
func _Auth_Login_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AuthServer).Login(m, &grpc.GenericServerStream[XLoginRequest, XLoginResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Auth_LoginServer = grpc.ServerStreamingServer[XLoginResponse]
