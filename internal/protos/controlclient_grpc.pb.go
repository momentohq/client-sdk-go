...
const (
	...
	ScsControl_GenerateApiToken_FullMethodName = "/control_client.ScsControl/GenerateApiToken"
)
...
func (c *scsControlClient) GenerateApiToken(ctx context.Context, in *XGenerateApiTokenRequest, opts ...grpc.CallOption) (*XGenerateApiTokenResponse, error) {
	out := new(XGenerateApiTokenResponse)
	err := c.cc.Invoke(ctx, ScsControl_GenerateApiToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedScsControlServer) GenerateApiToken(context.Context, *XGenerateApiTokenRequest) (*XGenerateApiTokenResponse, error) {
...
func _ScsControl_GenerateApiToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(XGenerateApiTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ScsControlServer).GenerateApiToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ScsControl_GenerateApiToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ScsControlServer).GenerateApiToken(ctx, req.(*XGenerateApiTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ScsControl_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ScsControl_GenerateApiToken_Handler,
		},
	},
