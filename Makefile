...
# internal/protos is generated by protoc-gen-go and refreshed by the update-protos
# workflow; it reports deprecations that cannot be fixed by hand here.
	@staticcheck $$(go list ./... | grep -v '/internal/protos')
